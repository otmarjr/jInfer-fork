...
public class ToStringSizeFactory implements RegexpEvaluatorFactory {

  /**
   * Canonical name.
   */
  public static final String NAME = "TwoStepClusterProcessorAutomatonMergingStateRegexpEvaluatorToStringSize";
  /**
   * Name presented to user.
   */
  public static final String DISPLAY_NAME = "ToStringSize";

  @Override
  public <T> RegexpEvaluator<T> create() {
    return new ToStringSize<T>();
  }
  ...
  public String getUserModuleDescription() {
    return "Computes codelength for regexp as number chars of its toString, not associative.";
  }
}
