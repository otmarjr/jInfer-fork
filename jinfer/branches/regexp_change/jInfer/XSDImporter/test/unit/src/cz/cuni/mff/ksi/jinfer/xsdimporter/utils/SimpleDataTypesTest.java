...
public class SimpleDataTypesTest {
  ...
  public void testIsStringType0() {
    ...
    String type = null;
    SimpleDataTypes.isStringType(type);
  }
  ...
  public void testIsStringType1() {
    ...
    boolean result = SimpleDataTypes.isStringType(type);
  ...
  public void testIsDateType0() {
    ...
    String type = null;
    SimpleDataTypes.isDateType(type);
  }
  ...
  public void testIsDateType1() {
    ...
    String type = "xs:date";
    boolean expResult = true;
    boolean result = SimpleDataTypes.isDateType(type);
    assertEquals(expResult, result);
  }
  ...
  public void testIsNumericType0() {
    ...
    String type = null;
    SimpleDataTypes.isNumericType(type);
  }
  ...
  public void testIsNumericType1() {
    ...
    boolean expResult = true;
    boolean result = SimpleDataTypes.isNumericType(type);
    assertEquals(expResult, result);
  }
  ...
  public void testIsTrickyNumericType0() {
    ...
    String type = null;
    SimpleDataTypes.isTrickyNumericType(type);
  }
  ...
  public void testIsTrickyNumericType1() {
    ...
    String type = "xs:byte";
    boolean expResult = true;
    boolean result = SimpleDataTypes.isTrickyNumericType(type);
    assertEquals(expResult, result);
  }
  ...
  public void testIsTrickyMiscType1() {
    ...
    boolean expResult = true;
    boolean result = SimpleDataTypes.isTrickyMiscType(type);
    assertEquals(expResult, result);
  }
  ...
  public void testIsMiscType0() {
    ...
    String type = null;
    SimpleDataTypes.isMiscType(type);
  }
  ...
  public void testIsMiscType1() {
    ...
    String type = "xs:QName";
    boolean expResult = true;
    boolean result = SimpleDataTypes.isMiscType(type);
    assertEquals(expResult, result);
  }
  ...
  public void testIsSimpleDataType0() {
    ...
    String type = null;
    SimpleDataTypes.isSimpleDataType(type);
  }
  ...
  public void testIsSimpleDataType1() {
    ...
    boolean expResult = true;
    boolean result = SimpleDataTypes.isSimpleDataType(type);
    assertEquals(expResult, result);
  }
