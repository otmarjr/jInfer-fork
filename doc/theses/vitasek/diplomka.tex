...
TODO what are trying to establish? What is our aim here? To get an understanding how the system and its components behave. What do the parameters affect. To see which types of data are best handled by specific algorithms. To see what are the time scales involved in ID search and how various parameters affect the run times of the heuristics.
...
\begin{table}
  ...
  \begin{tabular}{l | r | c | c | l}
	Name  & Size [kb] & Vertices & Edges & Optimum \\
	\hline
...
TODO explain edges, vertices and say that opt is the known for alpha = beta = 1

\begin{figure}
  \caption{Realistic data}
  \label{image-experiments-data-realistic}
  \centering
    \subfigure[OVA1]{\includegraphics[width=0.45\textwidth]{images/experiments/data/realistic/OVA1.eps}}
    \subfigure[OVA2]{\includegraphics[width=0.45\textwidth]{images/experiments/data/realistic/OVA2.eps}}
    \subfigure[OVA3]{\includegraphics[width=0.45\textwidth]{images/experiments/data/realistic/OVA3.eps}}
    \subfigure[XMA-c]{\includegraphics[width=0.08\textwidth]{images/experiments/data/realistic/XMA-c.eps}}
    \subfigure[XMA-p]{\includegraphics[width=0.08\textwidth]{images/experiments/data/realistic/XMA-p.eps}}
    \subfigure[XMD]{\includegraphics[width=0.45\textwidth]{images/experiments/data/realistic/XMD.eps}}
\end{figure}
...
TODO we can convert it back to keys!
...
\begin{figure}
  ...
  \centering
    \subfigure[MSH]{\includegraphics[width=0.08\textwidth]{images/experiments/data/converted/MSH.eps}}
    \subfigure[NTH]{\includegraphics[width=0.45\textwidth]{images/experiments/data/converted/NTH.eps}}
\end{figure}
...
TODO talk about some "density". Explain what is the max number of edges

TODO talk about the "size" test data
...
\begin{table}
  ...
  \begin{tabular}{l | r | c | c | c | c | l}
	Name  & Size [kb] & Vertices & Edges & $|E| / |V|$ & $|E| / |E_{max}|$ & Optimum \\
	\hline
...
TODO explain why the optimum is getting smaller
...
\begin{figure}
  ...
  \centering
    % TODO fix cropping
  	\subfigure[48-80]{\includegraphics[width=0.45\textwidth]{images/experiments/data/artificial/size/40-80.eps}}
	\subfigure[70-245]{\includegraphics[width=0.45\textwidth]{images/experiments/data/artificial/size/70-245-fixed.eps}}
\end{figure}

TODO why we have less than declared number? because of how we created it

\section{Experimental Setup}

TODO describe the actual HW/SW setup: two computers, Windows/Linux, versions etc. What is running when experimenting, that we are always using more runs to counter for effects like caches and stuff that happens. Say many things actually depend on the order in which we run the experiments in one set, and if it is relevant we will talk about it in that particular experiment.
