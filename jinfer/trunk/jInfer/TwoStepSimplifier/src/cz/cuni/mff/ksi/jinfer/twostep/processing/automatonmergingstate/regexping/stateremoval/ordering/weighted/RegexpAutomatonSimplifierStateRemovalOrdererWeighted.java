...
import cz.cuni.mff.ksi.jinfer.twostep.processing.automatonmergingstate.regexping.stateremoval.RegexpAutomatonStateRemoval;
...
public class RegexpAutomatonSimplifierStateRemovalOrdererWeighted<T> implements RegexpAutomatonSimplifierStateRemovalOrderer<T> {
  ...
  @Override
  public State<Regexp<T>> getStateToRemove(final RegexpAutomatonStateRemoval<T> automaton, final SymbolToString<Regexp<T>> symbolToString) throws InterruptedException {
