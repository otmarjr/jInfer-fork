...
\centering\includegraphics[scale=0.5]{reg_tree}
\end{figure}
...
% TODO explain what IG (or a grammar, for that matter) is
...
\begin{figure}
	...
	\centering\includegraphics[scale=0.5]{inference_process}
\end{figure}
...
\begin{enumerate}
	...
	% TODO anti: please format the indentation	
	\begin{verbatim}
		<a>
			<b>
				<c/>
