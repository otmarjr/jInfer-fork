...
Mixed element type is defined as \code{complexType} with attribute \code{mixed="true"}. Definition of the element from the last example may be as following.
...
\subsection{Definition of attributes}
