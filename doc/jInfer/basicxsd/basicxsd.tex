...
The main class implementing \code{SchemaGenerator} inference interface and simultaneously registered as its service provi\-der is \code{SchemaGeneratorImpl} in package \code{cz.cuni.mff.ksi.jinfer.basicxsd}. Process of export consists of two phases described in detail in later sections.
\begin{enumerate}
	\item Preprocessing.
