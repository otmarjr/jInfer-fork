...
public class TesterNullFactory implements MergeConditionTesterFactory {

  private static final Logger LOG = Logger.getLogger(TesterNullFactory.class);
  /**
   * Canonical name.
   */
  public static final String NAME = "TwoStepClusterProcessorAutomatonMergingStateMergeConditionTesterNull";
  /**
