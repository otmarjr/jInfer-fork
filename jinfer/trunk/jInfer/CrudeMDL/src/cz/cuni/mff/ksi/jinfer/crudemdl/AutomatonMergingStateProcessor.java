 ...
 * @author anti
 */
public class AutomatonMergingStateProcessor implements Processor<AbstractNode>{
  private static final Logger LOG = Logger.getLogger(AutomatonMergingStateProcessor.class);
  private Clusterer<AbstractNode> clusterer;

  @Override
  public List<AbstractNode> processClusters(final Clusterer<AbstractNode> clusterer) throws InterruptedException {
