...
/**
 * Factory for {@link GreedyMDL}.
 *
 * @author anti
 */
@ServiceProvider(service = AutomatonSimplifierFactory.class)
public class GreedyMDLFactory implements AutomatonSimplifierFactory {

  private static final Logger LOG = Logger.getLogger(GreedyMDLFactory.class);
  /**
   * Canonical name.
   */
  public static final String NAME = "TwoStepClusterProcessorAutomatonMergingStateAutomatonSimplifierGreedyMDL";
  /**
   * Name presented to user.
   */
  public static final String DISPLAY_NAME = "GreedyMDL";
  /**
