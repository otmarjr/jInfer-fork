...
Each cell contains the number of times the strategy found optimum in the data set, out of 20 runs. Highlighted are the strategies that performed best on that data set. We see that Strategy 1 and 3 are very similar in performance. We shall nonetheless choose Strategy \textbf{1} as the winner for its simplicity. Now we can tune its parameters.
