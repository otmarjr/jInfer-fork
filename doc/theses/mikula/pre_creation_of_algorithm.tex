...
Another step can be evaluation of the queries using the XML data and consecutive analysis of the results. And even the process of evaluation itself can be analyzed to obtain some useful information. \todo[inline]{Q: Toto skusit rozpisat nejak podrobnejsie? A: Ty useful information by neškodilo popsat, jinak OK.}
...
\todo[inline]{Tak náročnost implementace rozhodně není kritérium. Ta se udělá jednou. Navíc ve vědě (tj. i DP) nemá opodstatnění. Pro DP navíc platí, že nemusíte implementovat vše, co navrhnete. Implementace je pomocná věc, která slouží k tomu, abychom experimentálně ukázali vlastnosti a chování navrženého algoritmu.}

\todo[inline]{Pre co sme sa rozhodli? Odvozovat strukturu čistě z dotazů je nesmysl.}
