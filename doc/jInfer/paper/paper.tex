...
% TODO editors - oxygen, stylus, can they do something? how they do it, they are not free

\section*{Short architecture overview}
We divide the process of inference into three steps:
\begin{enumerate}
	\item 
	TODO steps, graph from architecture, short mention of internal structure = grammar
\end{enumerate}	
