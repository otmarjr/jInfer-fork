 ...
 * @author anti
 */
public interface ContentInferrerFactory extends NamedModule, Capabilities, UserModuleDescription {
  /**
   * Create {@link ContentInferrer}.
   * @return ContentInferrer instance
   */
  ContentInferrer create();
}
