...
public class StateRemovalHeuristicPropertiesPanel extends AbstractPropertiesPanel {

  private static final long serialVersionUID = 784463431L;

  /** Creates new form ModuleSelectionJPanel */
  public StateRemovalHeuristicPropertiesPanel(final Properties properties) {
    super(properties);
    initComponents();
  }
  ...
  private void initComponents() {
    ...
    labelOrderer.setText("Regexp Evaluator"); // NOI18N
  ...
  public final void load() {
    ...
    comboOrderer.setSelectedItem(ModuleSelectionHelper.lookupImpl(RegexpEvaluatorFactory.class,
            properties.getProperty(StateRemovalHeuristicFactory.PROPERTIES_REVAL,
            StateRemovalHeuristicFactory.PROPERTIES_REVAL_DEFAULT)));
    comboOrdererChanged(null);
  }

  @Override
  public void store() {
    properties.setProperty(StateRemovalHeuristicFactory.PROPERTIES_REVAL,
