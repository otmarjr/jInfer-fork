...
public class GreedyMDLPropertiesPanelProviderImpl implements PropertiesPanelProvider {
  ...
  public AbstractPropertiesPanel getPanel(final Properties properties) {
    return new GreedyMDLPropertiesPanel(properties);
  }

  @Override
  public String getName() {
    return GreedyMDLFactory.NAME;
  }

  @Override
  public String getDisplayName() {
    return GreedyMDLFactory.DISPLAY_NAME;
  }
