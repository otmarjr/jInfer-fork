...
public class KHContextPropertiesPanelProviderImpl implements PropertiesPanelProvider {

  private static final int PANEL_PRIORITY = 400001;

  @Override
  public AbstractPropertiesPanel getPanel(final Properties properties) {
    return new KHContextPropertiesPanel(properties);
  }

  @Override
  public String getName() {
    return KHContextFactory.NAME;
  }

  @Override
  public String getDisplayName() {
    return KHContextFactory.DISPLAY_NAME;
  }
