...
\todo[inline]{Algoritmy pouzivaju nejake nedefinovane funkcie, napr stepNode.getAxisNode().}
...
\todo[inline]{Definovat getParent() na Node.}
\todo[inline]{Popisat preco raz bereme target return path types a raz priamo paths.}
