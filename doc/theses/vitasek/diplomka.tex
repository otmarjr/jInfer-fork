...
\begin{figure}
  \caption{Realistic data - first part}
  \label{image-experiments-data-realistic-1}
  \centering
...
\begin{figure}
  \caption{Realistic data - second part}
  \label{image-experiments-data-realistic-2}
  \centering
    \subfigure[XMA-c]{\includegraphics[width=0.45\textwidth]{images/experiments/data/realistic/XMA-c.eps}}
    \subfigure[XMA-p]{\includegraphics[width=0.45\textwidth]{images/experiments/data/realistic/XMA-p.eps}}
...
\begin{figure}
  ...
  \centering
    \subfigure[MSH]{\includegraphics[width=0.45\textwidth]{images/experiments/data/converted/MSH.eps}}
...
\begin{figure}
  ...
  \centering
%  	\subfigure[100-100]{\includegraphics[width=0.45\textwidth]{images/experiments/data/artificial/100-100.eps}}
%	\subfigure[100-200]{\includegraphics[width=0.45\textwidth]{images/experiments/data/artificial/100-200.eps}}
%    \subfigure[100-1000]{\includegraphics[width=0.45\textwidth]{images/experiments/data/artificial/100-1000.eps}}    
\end{figure}
