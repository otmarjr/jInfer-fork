...
As it was mentioned in Section \ref{section-mip-ihs}, the combination of \heu{Crossover}, \heu{Mutation} and \heu{RemoveWorst} can be seen as a sort of genetic programming. However some modifications would still be necessary to make it a real instance of genetic algorithm metaheuristic.
