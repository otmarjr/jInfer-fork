...
\chapter{Použité technologie/pojmy}
\todo[inline]{Krátce popsat co je XML Schema, DTD, XPath, XQuery, možná ňejaký automat apod. Prostě co budete dále v textu potřebovat. Skratky: XSD, XSLT, ...}
...
\todo[inline]{Literatura tady určitě co nejpodrobněji - odkaz nestačí, za měsíc nemusí existovat. A nemělo by to přetékat okraj.}
