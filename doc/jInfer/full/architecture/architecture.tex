...
Regular expression is in fact $n$-ary tree, for example expression $(a, b, ((c | d), e), f)$ can be viewed as in figure \ref{reg_tree}.
\begin{figure}
...
Finally, our interface/class model for representing XML nodes is drafted on figure \ref{nodes}. Those, who are brave enough, can look on figure \ref{nodes_full}.
