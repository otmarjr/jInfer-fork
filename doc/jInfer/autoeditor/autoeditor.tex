...
\caption{Class diagram for the derived classes, not showing members of classes from figure \ref{uml_base_classes} to keep this diagram simple.} \label{uml_derived_classes}
\end{figure}
