...
\todo[inline]{Akeho typu je napr path expression /root/(elementA * 2)?}
...
If we cannot determine the type of an expression we express that using $null$. Example of such case is path expression $/rootElement/(elementA * 2)$. \todo{Nejak dopisat}
