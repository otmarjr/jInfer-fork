...
/**
 * Factory for {@link SKStringsDeterministic}.
 *
...
public class SKStringsDeterministicFactory implements MergeConditionTesterFactory {

  private static final Logger LOG = Logger.getLogger(SKStringsDeterministicFactory.class);
   ...
   * Canonical name.
   */
  public static final String NAME = "TwoStepClusterProcessorAutomatonMergingStateMergeConditionTesterSKStringsDeterministic";
  /**
   * Name presented to user.
   */
  public static final String DISPLAY_NAME = "s,k-strings (deterministic)";
  ...
  public <T> MergeConditionTester<T> create() {
    ...
    if ((parameterS >= 0) && (parameterS <= 100) && (parameterK > 0)
      ...
      return new SKStringsDeterministic<T>(parameterK, parameterS, parameterStrategy);
    } else {
      ...
      return new SKStringsDeterministic<T>(K_DEFAULT_VALUE, S_DEFAULT_VALUE, STRATEGY_DEFAULT_VALUE);
    }
  }
