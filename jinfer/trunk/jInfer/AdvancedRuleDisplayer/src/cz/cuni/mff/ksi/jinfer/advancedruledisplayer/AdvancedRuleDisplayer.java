...
import cz.cuni.mff.ksi.jinfer.advancedruledisplayer.logic.GraphBuilder;
...
public final class AdvancedRuleDisplayer {
  ...
  public static void showRulesAsync(final String panelName,
    ...
    WindowManager.getDefault().invokeWhenUIReady(new Runnable() {
      ...
      @Override
      public void run() {
        AdvancedRuleDisplayerTopComponent.findInstance().createNewPanel(panelName, GraphBuilder.buildGraphPanel(rules));
      }
    });
  }
}
