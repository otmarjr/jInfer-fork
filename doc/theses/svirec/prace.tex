...
\mfadvisor, Katedra softwarového inženýrství

% dle Organizační struktury MFF UK, případně plný název pracoviątě mimo MFF UK

Abstrakt:
Najviac používanými integritnými obmedzeniami v XML sú primárne a cudzie kľúče. Okrem nich však poznáme aj iný typ integritných obmedzení, a to funkčné závislosti. Tak ako pre relačné databázy,
