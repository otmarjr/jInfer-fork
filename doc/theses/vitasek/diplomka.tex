...
\begin{table}
  \caption{GLPK: native vs. Cygwin summary 1}
  \label{experiment-glpk-native-vs-cygwin-summary-1}
  \centering
  \begin{tabular}{| l | l |}
  \hline
  Machine           & Windows \\
...
\begin{table}
  \caption{GLPK: native vs. Cygwin summary 2}
  \label{experiment-glpk-native-vs-cygwin-summary-2}
  \centering
  \begin{tabular}{| l | l |}
  \hline
  Machine           & Windows \\
