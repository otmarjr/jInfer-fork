...
\item \textbf{Static Analysis of expression types}. The algorithm searches for expressions in the syntax trees and statically (without evaluation) determines their types. \todo{Co se mysli? Datove typy?}
...
\todo[inline]{Rekurzia sa nevnara do FunctionBodyNodes a PathExprNodes - napisat, alebo je to detail?}
...
\todo[inline]{Tu by neskodilo napisat, ze sice preberame alg, ale ho aj implementujeme a overime, co v povodnom clanku nebolo.}
...
The original approach \cite{Necasky:2009:DXK:1529282.1529414} employs the following normalization which we adopt. Is also incorporates a heuristic for precision enhancement. For details, we refer to it.
