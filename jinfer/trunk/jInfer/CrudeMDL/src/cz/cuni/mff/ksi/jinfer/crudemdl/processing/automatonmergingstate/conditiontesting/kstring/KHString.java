...
/**
 * Class representing KHString of state. KHcontext is path of states ending in
...
public class KHString<T> {
   ...
   * @param h
   */
  public KHString(final Integer k, final Integer h) {
   ...
   * @return
   */
  public List<Pair<State<T>, State<T>>> getMergeableStates(final KHString<T> another) {
  ...
  public String toString() {
    final StringBuilder sb= new StringBuilder("h,h-string: k=" + this.k.toString() + " h=" + this.h.toString() + ".\nSteps:");
