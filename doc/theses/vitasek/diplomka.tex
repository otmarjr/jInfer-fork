...
TODO link to the article mentioning how few XMLs have schemas

\chapter{Definitions}

TODO talk about key definition from \cite{keX}
...
\begin{itemize}
	...
	\item Key according to Keys for XML
...
TODO types of data:
\begin{itemize}
	\item Realistic - TODO talk about all that are used
	\item Artificial - random graphs - TODO talk about their generation
\end{itemize}

\section{Experimental Setup}

TODO we will be using jInfer, see \ref{jInfer}.
...
\begin{itemize}
	\item Input -> How long the search for optimum lasts
	\item Time limit -> Quality
