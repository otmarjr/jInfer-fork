...
public class Runner {
  ...
  private final IGGeneratorCallback iggCallback = new IGGeneratorCallback() {
    ...
    @Override
    public void finished(final List<AbstractStructuralNode> grammar) {
  ...
  public void finishedIGGenerator(final List<AbstractStructuralNode> grammar) {
  ...
  public void finishedSimplifier(final List<AbstractStructuralNode> grammar) {
