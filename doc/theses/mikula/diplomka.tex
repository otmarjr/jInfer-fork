...
Abstrakt: V poslední době bylo vyvinuto množství metod zabívajících se automatickým odvozováním XML schémy, většina z nich ale používá XML dokumenty ako jediný vstup. My se v tehle práci zaměřujeme na rozšíření odvozování začleněním XML operací, konkrétně XQuery dotazů. Diskutujeme jak je možné využít XQuery dotazy na vylepšení procesu odvozování a navrhujeme algoritmus založený na vybraných vylepšeních, který rozšiřuje existujíci metodu hledání klíčů a který může být začleněn do tzv. \emph{metod odvozujících gramatiku}. Implementováním algoritmu sme vytvořili první řešení odvozování XML schémy, ktoré využívá XML dokumenty spolu s XML operacemi.
