...
\end{itemize}
% TODO vektor Na jednej strane nas zaujima struktura, na to tam mame isElement() isSimpleData(), na druhej strane nas zaujimaju textove data, na to tam mame getContent() v SD aj atribute.
...
% TODO vito Aby bolo mozne odkazovat sa na uz zmergovane stavy, ktore sa uz volaju inak, pouzivame mapu premenovani.
