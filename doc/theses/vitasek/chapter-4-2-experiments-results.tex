...
After averaging the data we get a large result table, an excerpt from which is in Table \ref{table-experiments-chained-ihs-tweaking-s1}. Only the results for the biggest data sets and a few combinations of RR, MUT and CX ratios are presented.
...
The last experimental set will consist of 50 iterations = 50 experimental configurations. As with the previous one, \heu{Random} will be the CH, IHs will be from Strategy 1, however this time there will be no time limit. The process of generating the experimental set is in Listing \ref{listing-experiment-chained-ihs-tuned}.
