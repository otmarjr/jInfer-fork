 ...
 * @author anti
 */
public class StateRemoval<T> implements RegexpAutomatonSimplifier<T> {

  private static final Logger LOG = Logger.getLogger(StateRemoval.class);
   ...
   */
  public StateRemoval(final OrdererFactory ordererFactory) {
