...
public class VariousBetas extends ExperimentSet {
  ...
  protected List<ExperimentParameters> getExperiments() {
    final List<ImprovementHeuristic> improvement = Arrays.<ImprovementHeuristic>asList(new RandomRemove(0.1), new Mutation(0.1, 1), new RandomRemove(0.4), new Crossover(0.3, 1), new RemoveWorst());
