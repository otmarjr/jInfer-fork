...
/**
 * This class represents the XQuery library module.
 * 
...
public class LibraryModule extends Module {
  ...
  public LibraryModule(
          ModuleDeclNode moduleDeclNode, PrologNode prologNode) {
    assert (moduleDeclNode != null);
    assert (prologNode != null);
    getNodes().add(moduleDeclNode);
  ...
  public String getModuleTypeString() {
    return AttrValues.ATTR_VALUE_LIBRARY;
  }
}
