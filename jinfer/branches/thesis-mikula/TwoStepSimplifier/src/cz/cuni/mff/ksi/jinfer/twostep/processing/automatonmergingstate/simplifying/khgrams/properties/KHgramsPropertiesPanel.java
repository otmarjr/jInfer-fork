...
public class KHgramsPropertiesPanel extends AbstractPropertiesPanel {

  private static final long serialVersionUID = 784463435L;

  /** Creates new form ModuleSelectionJPanel */
  public KHgramsPropertiesPanel(final Properties properties) {
    super(properties);
    initComponents();
  }
  ...
  @Override
  public void store() {
    properties.setProperty(KHgramsFactory.PROPERTIES_K, txtK.getText());
    properties.setProperty(KHgramsFactory.PROPERTIES_H, txtH.getText());
  }
