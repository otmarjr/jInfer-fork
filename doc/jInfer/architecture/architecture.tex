...
\subsection{Node metadata} \label{section_metadata} % TODO vektor Move after Programmatic view
...
\begin{figure}
	\centering\includegraphics[scale=0.4]{module_deps}
	\caption{Module dependencies} \label{module_deps}
\end{figure}

\begin{figure}
	\centering\includegraphics[scale=0.4]{modules_inference}
...
TODO anti Link to http://bits.netbeans.org/dev/javadoc/org-openide-util-lookup/org/openide/util/Lookup.html as the official documentation to lookup API.
