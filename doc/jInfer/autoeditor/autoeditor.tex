...
TODO dopisat, translate, odkaz niekam na popis modulov

\code{Layout}s su implementovane pomocou modularneho systemu. Pre vyrobu noveho je treba vyrobit triedu implementujucu LayoutFactory a spravne ju oanotovat.
...
Constructor has one argument, instance of \code{Layout} class created from an automaton, typically by \code{LayoutHelperFactory} (see \ref{subsubsection:LayoutHelperFactory}).
