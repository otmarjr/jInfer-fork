...
public class BitCodeFactory implements RegexpEvaluatorFactory {
   ...
   * Canonical name.
   */
  public static final String NAME = "TwoStepClusterProcessorAutomatonMergingStateRegexpEvaluatorBitCode";
  /**
   * Name presented to user.
   */
  public static final String DISPLAY_NAME = "BitCode";

  @Override
  public <T> RegexpEvaluator<T> create() {
    return new BitCode<T>();
  }
