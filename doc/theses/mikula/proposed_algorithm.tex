...
A syntax tree constructed from sample query in Listing \ref{listing_testing_query_18} is shown in Figure \ref{FIG_syntax_tree_1}.
...
Figure \ref{FIG_syntax_tree_2} shows the syntax tree of the query in Listing \ref{listing_testing_query_8} (subtree of ConstructorNode is omitted because of lack of space). In this tree, the algorithm founds one occurrence of the join pattern 3. The two for clauses and one where clause which form the occurrence are shown in the red boxes.
