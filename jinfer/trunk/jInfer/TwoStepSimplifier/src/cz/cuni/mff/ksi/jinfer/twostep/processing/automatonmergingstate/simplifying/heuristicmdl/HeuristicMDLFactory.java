...
/**
 * Factory for {@link HeuristicMDL}.
 *
 * @author anti
 */
@ServiceProvider(service = AutomatonSimplifierFactory.class)
public class HeuristicMDLFactory implements AutomatonSimplifierFactory {

  private static final Logger LOG = Logger.getLogger(HeuristicMDLFactory.class);
  /**
   * Canonical name.
   */
  public static final String NAME = "TwoStepClusterProcessorAutomatonMergingStateAutomatonSimplifierHeuristicMDL";
  /**
   * Name presented to user.
   */
  public static final String DISPLAY_NAME = "HeuristicMDL";
  /**
