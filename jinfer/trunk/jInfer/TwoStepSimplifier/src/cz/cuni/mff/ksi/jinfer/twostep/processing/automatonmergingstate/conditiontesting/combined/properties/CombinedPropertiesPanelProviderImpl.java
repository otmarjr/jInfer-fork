...
public class CombinedPropertiesPanelProviderImpl implements PropertiesPanelProvider {

  private static final int PANEL_PRIORITY = 400000;

  @Override
  public AbstractPropertiesPanel getPanel(final Properties properties) {
    return new CombinedPropertiesPanel(properties);
  }
  ...
  public String getDisplayName() {
    return CombinedFactory.DISPLAY_NAME;
  }
