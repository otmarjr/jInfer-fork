...
According to our best knowledge at the time of writing there is just one approach of this category. It utilizes a set of XQuery queries to discover keys and foreign keys\todo{ref do literatury? Ty by tady něškodily všude, u každé té kategorie.}.
...
\todo[inline]{Definovat skratku XSD a co to je element type.}
...
\todo[inline]{Problém je, že tady ste v podstatě opsal ten článek. To je špatně. Analýza ex. přístupů by měla podat přehled toho, co se dnes v dané oblasti umí. Každý přístup by měl být popsán zhruba stejným stylem, stejně podrobně a s jednotným značením. Tj. ne zkopírovat různé odstavce z různých článků, z něčeho 20 řádků a z něčeho 6 stran. To není analýza ale plagiátorství.}
