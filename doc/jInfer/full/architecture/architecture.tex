...
% TODO vektor don't forget about advanced interface by capabilities.... don't know if to be mentioned right here, but don't forget
% TODO explain metadata and those that we already use
% TODO section about NBMs (anti: but i suppose it on the end of document)
...
% TODO anti: is it really necessary to write fig. by hand? Shouldn't it be automatic? anti: don't know, who cares... once it figure, once picture and maybe painting :D
...
\begin{enumerate}
	...
	% TODO anti: how about the whole examples in italic? anti: bleee
