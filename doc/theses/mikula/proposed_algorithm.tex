...
\todo{zistit, ci konstanty nahodou nie su jedine. NIE: CDataSectionNode, ContentNode(ale nemusi byt list), EntityRefNode, ContextItemExprNode, EmptySequenceNode, FunctionCallNode(bez parametrov), VarRefNode, FunctionBodyNode(prazdna funkcia), CharRefNode, AnyItemNode, AtomicTypeNode, KindTestNode(nemusi), NameTestNode, LocationHintNode, ModuleDeclNode, PrologNode, NameNode(nemusi), PITargetNode(nemusi), PragmaNode, BaseURIDeclNode, BoundarySpaceDeclNode, ConstructionDeclNode, CopyNamespacesDeclNode, DefaultCollationDeclNode, DefaultNamespaceDeclNode, EmptyOrderDeclNode, NamespaceDeclNode, OptionDeclNode, OrderingModeDeclNode, SelfOrDescendantStepNode, StringNode, TypeNode, VarValueNode}
