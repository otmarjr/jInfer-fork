...
jInfer and its documentation uses extended context-free grammars. % TODO vektor Cite, for example http://www.engr.mun.ca/~theo/Courses/fm/pub/context-free.pdf
\textit{Rules} in such grammar are in the form
% TODO anti Please make a proper arrow
...
Another important notion is a \textit{grammar}. A grammar consists of its rules, so in jInfer a grammar is just a collection of \code{Element}s. Closely related term is \textit{Initial Grammar}, which for us is a grammar consisting of rules with \textit{simple} right hand sides, i.e. just concatenations of tokens. Initial Grammar is produced by Initial Grammar Generator. % TODO vektor Link

% TODO explain metadata and those that we already use
% TODO section about NBMs
...
% TODO anti: is it really necessary to write fig. by hand? Shouldn't it be automatic?
...
\begin{enumerate}
	...
	% TODO anti: how about the whole examples in italic?
...
\textit{Simplifier} and \textit{Schema Generator} take grammar, % TODO vektor Link to grammar definition
